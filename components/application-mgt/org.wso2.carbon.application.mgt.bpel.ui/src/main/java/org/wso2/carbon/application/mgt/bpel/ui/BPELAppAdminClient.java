...
public class BPELAppAdminClient {
    ...
    public BPELAppAdminClient(String cookie,
                              String backendServerURL,
                              ConfigurationContext configCtx,
                              Locale locale) throws AxisFault {
        String serviceURL = backendServerURL + "BPELApplicationAdmin";
        bundle = ResourceBundle.getBundle(BUNDLE, locale);

        stub = new BPELApplicationAdminStub(configCtx, serviceURL);
    ...
    public BPELAppMetadata getBPELAppData(String appName) throws AxisFault {
        try {
            return stub.getBPELAppData(appName);
        } catch (Exception e) {
