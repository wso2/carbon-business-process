...
public class TenantAnalyticsAgentHolder {
    private static TenantAnalyticsAgentHolder instance;
    ...
    private TenantAnalyticsAgentHolder() {
    }

    public static TenantAnalyticsAgentHolder getInstance() {
        if (null == instance) {
            synchronized (TenantAnalyticsAgentHolder.class) {
                if(instance == null)
                instance = new TenantAnalyticsAgentHolder();
            }
        }
        return instance;
    }
