...
public class SourceImpl extends SourcesImpl implements SourceInterface {
     ...
     * @return Element(represents an element in a XML/HTML document) which contains the components of the Source
     * activity
     */
    @Override
     ...
     * @param id     = null
     * @return Empty element which contains the components of the Source activity.
     * In this case the Source activity doesn't contain any components, so no arrow definitions/paths from
     * activities
     */
