...
public class SourceImpl extends SourcesImpl implements SourceInterface {
    ...
    /**
     * Initializes a new instance of the SourceImpl class using the specified omElement
     * @param omElement which matches the Source tag
     */
    ...
    /**
     * Initializes a new instance of the SourceImpl class using the specified omElement
     * Constructor that is invoked when the omElement type matches an Source Activity when processing the subActivities
     * of the process
     * @param omElement which matches the Source tag
     * @param parent
     */
    ...
    /**
     *
     * @return String with the end tag of Source Activity
     */
    @Override
     ...
     * @return Element(represents an element in a XML/HTML document) which contains the components of the Source activity
     */
    @Override
     ...
     * @param id = null
     * @return Empty element which contains the components of the Source activity
     *         In this case the Source activity doesn't contain any components
     */
    protected Element getStartEndImageDef(SVGDocument doc, String imgPath, int imgXLeft, int imgYTop,
        ...
        Element group = null;
        group = doc.createElementNS(SVG_NAMESPACE, "g");
        return group;
    }
     ...
     * @param doc SVG document which defines the components including shapes, gradients etc. of the activity
     * @return Empty element which contains the components of the Source activity.
     *         In this case the Source activity doesn't contain any components, so no arrow coordinates
     */
    protected Element getArrows(SVGDocument doc) {
        Element subGroup = null;
        subGroup = doc.createElementNS(SVG_NAMESPACE, "g");
        return subGroup;
    }
     ...
     * @param id = null
     * @return Empty element which contains the components of the Source activity.
     *         In this case the Source activity doesn't contain any components, so no arrow definitions/paths from activities
     */
