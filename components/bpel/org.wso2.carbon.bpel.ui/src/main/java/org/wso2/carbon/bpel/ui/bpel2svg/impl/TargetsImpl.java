...
public class TargetsImpl extends ActivityImpl implements TargetsInterface {
     ...
     *         In this case the Targets activity doesn't contain any components
     */
     ...
     * @param doc SVG document which defines the components including shapes, gradients etc. of the activity
     * @return Empty element which contains the components of the Targets activity.
     *         In this case the Targets activity doesn't contain any components, so no arrow coordinates
     */
