 ...
 * under the License.
 */
package org.wso2.carbon.application.deployer.humantask.internal;
...
@Component(
        name = "application.deployer.humantask",
        immediate = true)
public class HumanTaskAppDeployerDSComponent {

    private static Log log = LogFactory.getLog(HumanTaskAppDeployerDSComponent.class);
