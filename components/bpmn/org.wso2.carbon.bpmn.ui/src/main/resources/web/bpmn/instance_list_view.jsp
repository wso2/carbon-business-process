...
<%
    boolean isAuthorizedForProcessInstances =
            CarbonUIUtil.isUserAuthorized(request, "/permission/admin/manage/bpmn/instance");
    if (isAuthorizedForProcessInstances) {
...
%>
    <div id="middle">
        <p><fmt:message key="do.not.have.permission.to.view.bpmn.instances"/></p>
    <div>
<%  }%>
</fmt:bundle>
