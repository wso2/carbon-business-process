...
<%@ page import="org.wso2.carbon.bpmn.ui.BPMNAnalyticsConfiguration" %>
...
//        RegistryUtils.setTrustStoreSystemProperties();
        ...
        if (configAction != null) {
            ...
            analyticsConfig.setThriftURL(thriftUrl);
            client.configureAnalytics(newConfig);
        }

        BPMNAnalyticsConfiguration analyticsConfig = clinet.getAnalyticsConfiguration();
