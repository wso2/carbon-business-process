...
public class RestUrls {
   ...
   // public static final String[] URL_DEPLOYMENT_COLLECTION = { SEGMENT_DEPLOYMENT_RESOURCE};
     ...
     */
    public static final String[] URL_DEPLOYMENT = { SEGMENT_DEPLOYMENT_RESOURCE, "{0}"};
     ...
     */
    public static final String[] URL_DEPLOYMENT_RESOURCE = { SEGMENT_DEPLOYMENT_RESOURCE, "{0}",
            SEGMENT_DEPLOYMENT_ARTIFACT_RESOURCE, "{1}"};
     ...
     */
    public static final String[] URL_DEPLOYMENT_RESOURCE_CONTENT = { SEGMENT_DEPLOYMENT_RESOURCE, "{0}",
            SEGMENT_DEPLOYMENT_ARTIFACT_RESOURCE_CONTENT, "{1}"};

    /**
     * URL template for the process definition collection: <i>repository/process-definitions</i>
     */
    public static final String[] URL_PROCESS_DEFINITION_COLLECTION = { SEGMENT_PROCESS_DEFINITION_RESOURCE};

    /**
     * URL template for a single process definition: <i>repository/process-definitions/{0:processDefinitionId}</i>
     */
    public static final String[] URL_PROCESS_DEFINITION = {SEGMENT_PROCESS_DEFINITION_RESOURCE, "{0}"};
     ...
     */
    public static final String[] URL_PROCESS_DEFINITION_RESOURCE_CONTENT = {SEGMENT_PROCESS_DEFINITION_RESOURCE, "{0}", SEGMENT_DEPLOYMENT_ARTIFACT_RESOURCE_CONTENT};
     ...
     */
    public static final String[] URL_PROCESS_DEFINITION_IDENTITYLINKS_COLLECTION = { SEGMENT_PROCESS_DEFINITION_RESOURCE, "{0}", SEGMENT_IDENTITYLINKS};
     ...
     */
    public static final String[] URL_PROCESS_DEFINITION_IDENTITYLINK = { "{0}", SEGMENT_IDENTITYLINKS, "{1}", "{2}"};

    /**
     * URL template for the model of a process definition: <i>repository/process-definitions/{0:processDefinitionId}/model</i>
     */
    public static final String[] URL_PROCESS_DEFINITION_MODEL = { SEGMENT_PROCESS_DEFINITION_RESOURCE, "{0}", SEGMENT_MODEL};

    /**
     * URL template for the image of a process definition: <i>repository/process-definitions/{0:processDefinitionId}/image</i>
     */
    public static final String[] URL_PROCESS_DEFINITION_IMAGE = { SEGMENT_PROCESS_DEFINITION_RESOURCE, "{0}", SEGMENT_IMAGE};
   ...
   // public static final String[] URL_MODEL_COLLECTION = { SEGMENT_MODEL_RESOURCE};
     ...
     */
    public static final String[] URL_TASK = {SEGMENT_TASK_RESOURCE, "{0}"};
     ...
     */
    public static final String[] URL_TASK_VARIABLE_DATA = { SEGMENT_TASK_RESOURCE, "{0}", SEGMENT_VARIABLES, "{1}", SEGMENT_VARIABLE_DATA};
     ...
     */
    public static final String[] URL_TASK_IDENTITYLINK = {SEGMENT_TASK_RESOURCE, "{0}", SEGMENT_IDENTITYLINKS, "{1}", "{2}", "{3}"};
     ...
     */
    public static final String[] URL_TASK_COMMENT = {SEGMENT_TASK_RESOURCE, "{0}", SEGMENT_COMMENTS, "{1}"};
     ...
     */
    public static final String[] URL_TASK_EVENT = {SEGMENT_TASK_RESOURCE, "{0}", SEGMENT_EVENTS, "{1}"};
     ...
     */
    public static final String[] URL_TASK_ATTACHMENT = {SEGMENT_TASK_RESOURCE, "{0}", SEGMENT_ATTACHMENTS, "{1}"};

    /**
     * URL template for the content for an attachment on a task: <i>runtime/tasks/{0:taskId}/attachments/{1:attachmentId}/content</i>
     */
    public static final String[] URL_TASK_ATTACHMENT_DATA = {SEGMENT_TASK_RESOURCE, "{0}", SEGMENT_ATTACHMENTS, "{1}", SEGMENT_ATTACHMENT_CONTENT};
     ...
     */
    public static final String[] URL_EXECUTION = {SEGMENT_EXECUTION_RESOURCE, "{0}"};

    /**
     * URL template for the restVariables for an execution: <i>runtime/executions/{0:executionId}/variables</i>
     */
    ...
    /**
     * URL template for a single restVariables for an execution: <i>runtime/executions/{0:executionId}/variables/{1:variableName}</i>
     */
    ...
    /**
     * URL template for a single restVariables for an execution: <i>runtime/executions/{0:executionId}/variables/{1:variableName}/data</i>
     */
    public static final String[] URL_EXECUTION_VARIABLE_DATA = {SEGMENT_EXECUTION_RESOURCE, "{0}", SEGMENT_VARIABLES, "{1}", SEGMENT_VARIABLE_DATA};
     ...
     */
    public static final String[] URL_PROCESS_INSTANCE = {SEGMENT_PROCESS_INSTANCE_RESOURCE, "{0}"};
     ...
     */
    public static final String[] URL_PROCESS_INSTANCE_VARIABLE_DATA= { SEGMENT_PROCESS_INSTANCE_RESOURCE, "{0}", SEGMENT_VARIABLES, "{1}", SEGMENT_VARIABLE_DATA};
     ...
     */
    public static final String[] URL_HISTORIC_PROCESS_INSTANCE_COMMENT = {SEGMENT_HISTORIC_PROCESS_INSTANCE_RESOURCE, "{0}", SEGMENT_COMMENTS, "{1}"};
     ...
     */
    public static final String[] URL_PROCESS_INSTANCE_IDENTITYLINK = {SEGMENT_PROCESS_INSTANCE_RESOURCE, "{0}", SEGMENT_IDENTITYLINKS, SEGMENT_IDENTITYLINKS_FAMILY_USERS, "{1}", "{2}"};

    /**
     * URL template for a single historic process instance: <i>history/historic-process-instances/{0:processInstanceId}</i>
     */
    public static final String[] URL_HISTORIC_PROCESS_INSTANCE = {SEGMENT_HISTORIC_PROCESS_INSTANCE_RESOURCE, "{0}"};
     ...
     */
    public static final String[] URL_HISTORIC_PROCESS_INSTANCE_VARIABLE_DATA = {SEGMENT_HISTORIC_PROCESS_INSTANCE_RESOURCE, "{0}", SEGMENT_VARIABLES, "{1}", SEGMENT_VARIABLE_DATA};

    /**
     * URL template for a single historic task instance: <i>history/historic-task-instances/{0:taskId}</i>
     */
    public static final String[] URL_HISTORIC_TASK_INSTANCE = {SEGMENT_HISTORIC_TASK_INSTANCE_RESOURCE, "{0}"};
     ...
     */
    public static final String[] URL_HISTORIC_TASK_INSTANCE_VARIABLE_DATA = { SEGMENT_HISTORIC_TASK_INSTANCE_RESOURCE, "{0}", SEGMENT_VARIABLES, "{1}", SEGMENT_VARIABLE_DATA};
     ...
     */
    public static final String[] URL_HISTORIC_VARIABLE_INSTANCE_DATA = { SEGMENT_HISTORIC_VARIABLE_INSTANCE_RESOURCE, "{0}", SEGMENT_VARIABLE_DATA};
     ...
     */
    public static final String[] URL_HISTORIC_DETAIL_VARIABLE_DATA = { SEGMENT_HISTORIC_DETAIL_RESOURCE, "{0}", SEGMENT_VARIABLE_DATA};
