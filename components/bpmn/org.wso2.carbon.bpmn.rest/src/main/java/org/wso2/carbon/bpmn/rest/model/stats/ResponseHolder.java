...
public class ResponseHolder {
    ...
    @XmlElements(value = {
            @XmlElement(name = "Task",
                    type = TaskInstanceAverageInfo.class),
            @XmlElement(name = "CompletedProcess",
                    type = ProcessInstanceAverageInfo.class),
            @XmlElement(name = "DeployedProcess",
                    type = InstanceCountInfo.class),
            @XmlElement(name = "InstanceVariation",
                    type = ProcessInstanceStatInfo.class),
            @XmlElement(name = "ProcessInstanceStatusCountInfo",
                    type = ProcessInstanceStatusCountInfo.class),
            @XmlElement(name = "UserTaskCountInfo",
                    type = UserTaskCountInfo.class),
