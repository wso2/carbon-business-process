...
<body>
<div id="logOut"><a class="taskListLogout" href="<%=logoutLink%>"
                    style="display:block;padding:0px 0px 10px 0px">Logout</a></div>
...
<div class="tabs_task" id="tabs_task">
    <ul>
        ...
        <li><a onclick="selectTabTaskFilteringGadget(this)" id="claimableTasks" rel="claimableTasksTab">Claimable</a>
        </li>
        <li><a onclick="selectTabTaskFilteringGadget(this)" id="adminTasks" rel="adminTasksTab">Admin Tasks</a></li>
        <li><a onclick="selectTabTaskFilteringGadget(this)" id="notifications" rel="notificationsTab">Notifications</a>
        </li>
