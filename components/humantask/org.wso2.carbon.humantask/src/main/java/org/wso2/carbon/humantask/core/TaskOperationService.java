...
/**
 * OSGI service exposing TaskService
 */
public interface TaskOperationService {

    public TTaskSimpleQueryResultSet simpleQuery(TSimpleQueryInput tSimpleQueryInput)
            throws IllegalStateFault, IllegalArgumentFault ;

    public void complete(URI taskIdURI, String outputStr)
