...
public class OrganizationalEntityProviderFactory {
    ...
    public static OrganizationalEntityProvider getOrganizationalEntityProvider(TFrom tFrom) {
        if (tFrom.isSetLogicalPeopleGroup()) {
            return new LogicalPeopleGroupBasedOrgEntityProvider();
        }
        if (tFrom.isSetLiteral()) {
            return new LiteralBasedOrgEntityProvider();
        }
        return new ExpressionBasedOrgEntityProvider();
    }
